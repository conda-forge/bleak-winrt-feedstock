...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/bleak-winrt-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bleak-winrt-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add bleak-winrt
# for installing globally
pixi global install bleak-winrt
```
...
It is possible to list all of the versions of `bleak-winrt` available on your platform:
...
```
pixi search bleak-winrt --channel conda-forge
```
